                                            ...
                                            <tr>
                                                <td valign="top" align="center" style="padding:0;Margin:0;width:560px">
                                                    <table width="100%" cellspacing="0" cellpadding="0" role="presentation" style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px">
                                                        ...
                                                        <tr>
                                                            <td align="center" style="padding:0;Margin:0;padding-bottom:15px"><p style="Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-family:'open sans', 'helvetica neue', helvetica, arial, sans-serif;line-height:21px;color:#FFFFFF;font-size:14px">Вы получили это письмо так как регистрировались на нашем сайте.<br>Чтобы отписаться от рассылки перейдите <a target="_blank" style="-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;text-decoration:underline;color:#cee44a;font-size:14px" href="%UNSUBSCRIBE_LINK%">по ссылке</a></p></td>
                                                        </tr>
                                                    </table></td>
                                            </tr>
                                        </table></td>
